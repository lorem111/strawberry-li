        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 mb-16">
          ...
          <div className="md:col-span-3 md:col-start-7">
            ...
            <nav className="flex flex-col gap-4">
              ...
              <a href="https://discord.gg/WFVZnBMzdc" target="_blank" rel="noopener noreferrer" className="text-sm font-medium hover:text-[var(--primary)] transition-colors duration-200 w-fit">Discord</a>

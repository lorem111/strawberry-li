    ...
    >
      ...
      <div className="relative z-10 container mx-auto px-6 max-w-5xl flex flex-col items-center text-center space-y-8">
        ...
        <div className="flex flex-col sm:flex-row flex-wrap gap-4 w-full sm:w-auto pt-4 justify-center">
          <a href="/api/download" download className="group relative px-8 py-4 bg-[var(--foreground)] text-[var(--background)] rounded-full font-semibold text-sm transition-all hover:scale-105 hover:shadow-[0_0_40px_-10px_var(--primary)] flex items-center justify-center gap-2">
